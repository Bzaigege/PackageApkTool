...
# 修改头号游戏渠道资源
class ThyxChannel(SpecialChannel.SpecialChannel):
    ...
    def modify_manifest_resource(self, channel_path, channel_version, config):
        ...
        try:
            ...
            appid_meta = find_node_by_name(meta_data_nodes, 'com.sfchannel.appid')
            if app_id and appid_meta != None:
                appid_meta.set(Node_value, app_id)

            appkey_meta = find_node_by_name(meta_data_nodes, 'com.sfchannel.appkey')
            if app_id and appkey_meta != None:
